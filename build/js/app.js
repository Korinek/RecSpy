...
$templateCache.put("app/dashboard/dashboard.html","<div class=container><div ng-repeat=\"gym in vm.memberships\" ng-show=\"vm.currentlyDisplayedGym === gym\" class=col-centered><a href ng-click=vm.moveLeft() ng-show=\"vm.memberships.length > 1\" class=nav-arrow-left><img src=left_arrow.png></a><h3 class=dashboard-gym-title>{{gym.name}}</h3><a href ng-click=vm.moveRight() ng-show=\"vm.memberships.length > 1\" class=nav-arrow-right><img src=right_arrow.png></a><h4>Best Time To Go: {{vm.currentlyDisplayedGym.bestTime}}</h4><h4>{{vm.fullnessMessage}}</h4><div class=\"progress dashboard-progress-bar\"><div ng-repeat=\"percentage in vm.percentages\" ng-class=\"{\'progress-bar\': true, \'dashboard-progress-level\': true, \'progress-bar-success\': vm.currentPercentage <= 50, \'progress-bar-warning\': vm.currentPercentage > 50 && vm.currentPercentage <= 80, \'progress-bar-danger\': vm.currentPercentage > 80}\" ng-show=\"percentage <= vm.currentPercentage\"></div></div></div></div>");
$templateCache.put("app/employment/employment.html","<div ng-show=!vm.employment class=container><div class=col-centered>You are not currently employed at any registered gym.</div><br><ul class=\"col-md-6 list-group\"><li class=\"list-group-item active\">Possible Employment</li><li ng-repeat=\"possibleEmployment in vm.possibleEmployments\" class=list-group-item>{{possibleEmployment.name}}<div class=pull-right><a href ng-click=vm.requestEmployment(possibleEmployment)><img src=add.png></a></div></li></ul><ul class=\"col-md-6 list-group\"><li class=\"list-group-item active\">Pending Employment</li><li ng-repeat=\"pendingEmployment in vm.pendingEmployments\" class=list-group-item>{{pendingEmployment.name}}<div class=pull-right><a href ng-click=vm.deleteEmployment(pendingEmployment)><img src=cross.png></a></div></li></ul></div><div ng-show=vm.employment class=container><h3 class=col-centered>{{vm.employment.name}}</h3><br><div class=col-centered><label>First Name: <input ng-model=search.firstName></label> <label>Last Name: <input ng-model=search.lastName></label></div><br><ul class=\"col-md-6 list-group\"><li class=\"list-group-item active\">Checked In</li><li ng-repeat=\"checkedInMember in vm.employment.checkedInMembers | filter:search:strict\" class=list-group-item>{{checkedInMember.firstName + \' \' + checkedInMember.lastName}}<div class=pull-right><a href ng-click=vm.checkOutMember(checkedInMember)><img src=right_arrow.png></a></div></li></ul><ul class=\"col-md-6 list-group\"><li class=\"list-group-item active\">Checked Out</li><li ng-repeat=\"checkedOutMember in vm.employment.checkedOutMembers | filter:search:strict\" class=list-group-item><div class=pull-left><a href ng-click=vm.checkInMember(checkedOutMember)><img src=left_arrow.png></a></div>{{checkedOutMember.firstName + \' \' + checkedOutMember.lastName}}</li></ul></div>");
$templateCache.put("app/gyms/gyms.html","<div class=container><div class=\"col-md-3 col-centered\"><input placeholder=\"Gym Name\" ng-model=search.name></div><br><ul class=\"list-group col-centered col-md-3\"><li class=\"list-group-item active\">Gyms</li><li ng-repeat=\"gym in vm.gyms | filter:search:strict\" class=\"list-group-item left-align\">{{gym.name}}<div class=pull-right><a href ng-show=\"!gym.isCurrentUserMember && !gym.isCurrentUserPendingMember\" ng-click=vm.requestMembership(gym)><img src=add.png></a> <a href=/memberships ng-show=gym.isCurrentUserPendingMember><img src=question.png></a> <a href=/memberships ng-show=gym.isCurrentUserMember><img src=check.png></a></div></li></ul></div>");
